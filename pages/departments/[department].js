...
export default function DepartmentPage() {
  ...
  whileHover={{ y: -10 }}
  className="relative bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100 flex flex-col transition-all hover:shadow-2xl"
>
  ...
  <div className="p-5 flex flex-col flex-grow">
    ...
    >
      ...
      <Link
        ...
        className="block w-full text-center py-2.5 rounded-lg text-white font-semibold text-sm"
        style={{
          background:
