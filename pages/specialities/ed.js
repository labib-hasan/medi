                  ...
                  {displayedDoctors.map((doctor, index) => (
                    ...
                    >
                      ...
                      <div className="p-3 flex flex-col flex-grow">
                        ...
                        <p className="text-red-600 text-[11px] text-center mt-auto">
                        ...
                        <div className="grid grid-cols-3 text-center border-t border-b border-gray-100 mt-auto text-[10px]">
                          ...
                          <div className="text-center">
                            ...
                            <p className="font-semibold text-gray-800 text-[10px]">
                              {formatTimeToAMPM(doctor.visiting_time) || "24/7"}
                            </p>
                          </div>
                        ...
                        >
                          <Link
                            ...
                            className="inline-flex items-center justify-center gap-2 w-full py-3 bg-gradient-to-r from-red-600 to-orange-600 text-white rounded-3xl font-semibold text-sm hover:from-red-500 hover:to-orange-700 transition shadow-lg shadow-red-500/25"
                          >
                            View Full Profile
                          </Link>
                        </motion.div>
