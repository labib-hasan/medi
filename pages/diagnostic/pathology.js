...
const fallbackPathologyDoctors = [
  { id: 1, name: "Prof. Dr. Fazle Hossain", specialization: "Senior Consultant – Pathology", degrees: "MBBS, FCPS, MD", designation: "Senior Consultant", institute: "Medical Center Hospital Chattagram", experience_years: 28, room_no: "PATH-101", visiting_days: ["Sunday", "Monday", "Tuesday"], visiting_time: "9 AM - 5 PM", serial_note: "Call hotline", phone: "+8801234567890" },
  { id: 2, name: "Dr. Rabeya Begum", specialization: "Consultant – Clinical Pathology", degrees: "MBBS, MD, DCP", designation: "Consultant", institute: "Medical Center Hospital Chattagram", experience_years: 18, room_no: "PATH-102", visiting_days: ["Saturday", "Monday", "Wednesday"], visiting_time: "10 AM - 4 PM", serial_note: "First come first serve", phone: "+8801234567891" },
  { id: 3, name: "Dr. Kamal Hossain", specialization: "Specialist – Hematology", degrees: "MBBS, MD", designation: "Specialist", institute: "Medical Center Hospital Chattagram", experience_years: 12, room_no: "PATH-103", visiting_days: ["Sunday", "Tuesday", "Thursday"], visiting_time: "8 AM - 2 PM", serial_note: "Emergency cases prioritized", phone: "+8801234567892" },
  { id: 4, name: "Dr. Shapla Rani", specialization: "Associate Specialist – Biochemistry", degrees: "MBBS, DCH", designation: "Associate Specialist", institute: "Medical Center Hospital Chattagram", experience_years: 7, room_no: "PATH-104", visiting_days: ["Monday", "Wednesday", "Friday"], visiting_time: "11 AM - 6 PM", serial_note: "Online booking available", phone: "+8801234567893" },
];

// Department name for API query - must match exactly with admin/doctors.js
const SPECIALTY_DEPARTMENT = "Pathology";
...
export default function PathologyPage() {
  const [doctors, setDoctors] = useState(fallbackPathologyDoctors);
      ...
      <section className="relative h-[300px] md:h-[420px] overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-black/80 via-black/50 to-transparent flex items-center">
          <div className="max-w-7xl mx-auto px-4">
            ...
            >
              Comprehensive Laboratory Services at Medical Center Hospital Chattagram
            </motion.p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            <h2 className="text-2xl md:text-3xl font-bold text-blue-700 mb-4">
              Pathology Services – Medical Center Hospital Chattagram
            </h2>
            <p className="text-gray-700 leading-relaxed">
              The Pathology Department at Medical Centre Hospital offers comprehensive diagnostic laboratory services using state-of-the-art technology. Our team of experienced pathologists provides accurate diagnoses and expert interpretation for a wide range of medical conditions.
            </p>
          </motion.div>

          {/* PATHOLOGY SERVICES & FEATURES GRID */}
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            <h3 className="text-xl md:text-2xl font-semibold text-gray-800 mb-6">
              Pathology Services & Features
            </h3>
            <div className="grid md:grid-cols-2 gap-8">
              {[
                { title: "Clinical Pathology", text: "Complete blood count, urinalysis, stool examination, and other routine tests." },
                { title: "Biochemistry", text: "Liver function tests, kidney function tests, lipid profile, and blood sugar tests." },
                { title: "Hematology", text: "Blood typing, coagulation studies, hemoglobin electrophoresis, and bone marrow examination." },
                { title: "Microbiology", text: "Culture and sensitivity, antibiotic susceptibility testing, and infectious disease screening." },
                { title: "Histopathology", text: "Tissue biopsy examination, surgical pathology, and cancer diagnosis." },
                { title: "Immunology", text: "Allergy testing, autoimmune disease markers, and vaccine titer testing." },
              ].map((item, i) => (
                <motion.div
                  key={i}
          ...
          {/* PATHOLOGY SPECIALISTS – FROM DATABASE */}
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.7 }}
          >
            <div className="mb-8 text-center">
              ...
              <p className="text-gray-600 mt-2">
                Highly experienced pathologists and laboratory medicine specialists
              </p>
                      ...
                      <div className="w-full p-4 flex flex-col h-[240px]">
                        <div className="flex flex-col h-full">
                          ...
                          <p className="text-gray-600 text-sm h-5 leading-5 truncate flex-shrink-0">
                            {doctor.institute || "Medical Center Hospital Chattagram"}
                          </p>
          ...
          >
            <div className="bg-gradient-to-r from-blue-600 to-cyan-500 rounded-2xl p-8 text-white text-center">
              <h3 className="text-2xl font-bold mb-4">Need Laboratory Tests?</h3>
              <p className="mb-6 max-w-2xl mx-auto">
                Our pathology department provides comprehensive laboratory services. Contact us for test information and sample collection appointments.
              </p>
